...
public class TodoResource {
    ...
    public Todo getById(@PathVariable String username, @PathVariable Integer id){
    ...
    @PostMapping("/users/{username}/todos/other")
    public ResponseEntity<Void> createTodoOther(@PathVariable String username, @PathVariable Integer id, @RequestBody Todo todo){
